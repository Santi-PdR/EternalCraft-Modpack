...
function sanitizeImportedSettings(raw={}) {
  ...
  if(raw.launcher&&typeof raw.launcher==='object') {
    const l=raw.launcher; const themes=new Set(['aurora','tactical','crimson','frost','obsidian','dvn','classic','dominion','nusia','ember','clean']); const backgrounds=new Set(['frontline','night','canyon','anniversary','cyborg','dummies','orbit','laststand','vought','nightop','rooftop','tempest','urban']);
