...
- Temas ampliados: Aurora Command, Tactical Field, Crimson Alert, Frostline, Obsidian, DVN Pulse y SIEGE Classic.
- Temas cambian superficies, navegación, tarjetas, botones y tratamiento de la portada, no solo el color de acento.
- Opción de fondo aleatorio al abrir.
- GPU dedicada sigue preferida por defecto.
- La sección desarrollador permanece oculta en Windows.
- El modpack estable parte de la versión 1.0.0 y mantiene nombres automáticos de dos palabras en cada publicación.
